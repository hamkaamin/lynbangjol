...
<section id="subintro">
    ...
    <div class="container-fluid">
      <div class="row-fluid" style="margin-bottom: 0px">
        <div class="span4">
            ...
            <h3 style="margin-left: 50px">Input <strong>KATEGORI - JURNAL</strong></h3>
        </div>
        <div class="span8">
          <ul class="breadcrumb notop">
            <li><a href="{{ url('home') }}">Home</a><span class="divider">/</span></li>
            <li><a href="{{ url('jurnalKategori') }}">Penulis - Jurnal</a><span class="divider">/</span></li>
  ...
  <section id="maincontent">
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span12">
          <h4 class="heading"><strong>Tambah Data</strong> Kategori - Jurnal<span></span></h4>
            ...
            <form action="{{ url('jurnalKategori') }}" method="post" enctype="multipart/form-data" class="comment-form" name="comment-form"> 
            {!! csrf_field() !!} 
            <div class="span6">
