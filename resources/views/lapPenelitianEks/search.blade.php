...
<section id="subintro">
      ...
      <div class="row-fluid" style="margin-bottom: 0px">
        ...
        <div class="span8">
          <ul class="breadcrumb notop">
            ...
            <li><a href="{{ url('lapPenelitianEks') }}">Laporan Penelitian Eksternal</a><span class="divider">/</span></li>
  ...
  <section id="maincontent">
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span12">
            <form action="{{ url('lapPenelitianEks/execAdvSearch') }}" method="GET" class="comment-form" name="comment-form">
            {{ method_field("PUT") }} 
            {!! csrf_field() !!}
