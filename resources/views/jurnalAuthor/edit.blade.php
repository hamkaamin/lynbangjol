    ...
    <div class="container-fluid">
      <div class="row-fluid" style="margin-bottom: 0px">
        <div class="span4">
            ...
            <h3 style="margin-left: 50px">Edit <strong>PENULIS - ARTIKEL JURNAL</strong></h3>
        </div>
        <div class="span8">
          <ul class="breadcrumb notop">
            <li><a href="{{ url('home') }}">Home</a><span class="divider">/</span></li>
            <li><a href="{{ url('jurnalAuthor') }}">Penulis - Artikel Jurnal</a><span class="divider">/</span></li>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span12">
            ...
            <form action="{{ route('jurnalAuthor.update', $jurnalAuthors->id) }}" method="post" enctype="multipart/form-data" class="comment-form" name="comment-form" onsubmit="return confirm('Konfirmasi Perubahan Data');"> 
            {{ method_field("PUT") }} 
            {!! csrf_field() !!}
            ...
            <div class="span6">
                ...
                <select id="artikel_id" class="form-control" name="artikel_id" required autofocus>
                    @foreach ($jurnalArtikels as $key => $jurnalArtikel)
                        @if( $jurnalArtikel->id  == $jurnalAuthors->artikel_id )
                        <option value="{{ $jurnalArtikel->id }}" selected="true">{{ $jurnalArtikel->judul }}</option>
                      @else
            ...
            <div class="span6">
                ...
                <select id="author_id" class="form-control" name="author_id" required autofocus>
                    @foreach ($authors as $key => $author)
                        @if( $author->id  == $jurnalAuthors->author_id )
            ...
            <div class="span6" style="text-align: center">
                ...
                <a class="btn btn-color" style="line-height: 30px; font-size: 14px" href="{{ url('jurnalAuthor') }}">
                    Kembali</a>
            </div>
            <div class="clear"></div>
