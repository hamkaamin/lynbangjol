    ...
    <div class="container-fluid">
      <div class="row-fluid" style="margin-bottom: 0px">
        <div class="span4">
            ...
            <h3 style="margin-left: 50px">Input <strong>PELAKSANA - LAPORAN</strong></h3>
        </div>
        <div class="span8">
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span12">
            ...
            <form action="{{ url('laporanLembaga') }}" method="post" enctype="multipart/form-data" class="comment-form" name="comment-form"> 
            {!! csrf_field() !!} 
            <div class="span6">
