                  ...
                  <div class="span12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6" style="width:90%">
                                            <textarea id="issue" rows="5" type="issue" class="form-control" name="issue" readonly>{{$rekap->issue}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6" style="width:90%">
                                            <textarea id="urgensi" rows="5" type="urgensi" class="form-control" name="urgensi" readonly>{{$rekap->urgensi}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6" style="width:90%">
                                            <textarea id="harapan" rows="5" type="harapan" class="form-control" name="harapan" readonly>{{$rekap->harapan}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6" style="width:90%">
                                            <textarea id="manfaat" rows="5" type="manfaat" class="form-control" name="manfaat" readonly>{{$rekap->manfaat}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="span6" style="text-align: center">
                                        <button type="button" class="btn btn-primary" style="padding: 12px 20px; font-size: 16px" onclick="btnBack()">Kembali</button>
                                    </div>
