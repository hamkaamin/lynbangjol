    ...
    <div class="container-fluid">
      <div class="row-fluid" style="margin-bottom: 0px">
        <div class="span4">
            ...
            <h3 style="margin-left: 50px">Input <strong>JURNAL</strong></h3>
        </div>
        <div class="span8">
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span12">
            ...
            <form action="{{ url('jurnal') }}" method="post" enctype="multipart/form-data" class="comment-form" name="comment-form"> 
            {!! csrf_field() !!} 
            <div class="span6">
                <label for="nama" class="control-label">Nama</label>
                <input id="nama" type="text" class="form-control" name="nama" placeholder="<< Nama Jurnal >>" required autofocus />
            </div>
            <div class="clear"></div>
            ...
            <div class="span6">
                ...
                <input id="volume" type="text" class="form-control" name="volume" placeholder="<< Volume Jurnal >>" required/>
            </div>
            <div class="clear"></div>
